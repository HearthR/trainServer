...
document.addEventListener('DOMContentLoaded', () => {
    ...
    stAutoComplete(document.querySelector("#input-path-src > input"), stations);
    stAutoComplete(document.querySelector("#input-path-dst > input"), stations);
...
const closeLists = () => {
    // let x = document.querySelectorAll("#autocomplete-list > div");
